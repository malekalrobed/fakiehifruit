...
<div class="section-page">
    ...
    <section class="short-cut">
        <div class="container">
            <a href="/" class="link">الرئيسية  </a> &#10095; <span class="link"> {{ $product->name }} </span>
        </div>            								
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6" style="margin-top: 40px;">
                    <div class="text"><h1>{{ $product->name }} - {{ $product->unit }}</h1></div>
                    <div class="price">
    ...
    <section class="collections">
        <div class="container">                      
            <h3 class="main-title">المنتجات ذات الصلة</h3>                        
            <div class="row">
