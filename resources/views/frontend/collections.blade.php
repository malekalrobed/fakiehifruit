...
<div class="section-page">
    @if(count($products) > 0)
    <div class="caption" style="background-image: url({{ asset('storage/images/collections'.'/'.$collection->image) }})">
        <div class="overlay">
    ...
    <section class="short-cut">
        <div class="container">
            <a href="/" class="link">الرئيسة  </a> &#10095; <span class="link"> {{ $collection->name }} </span>
        </div>            								
    </section>

    <section class="collections">
        <div class="container">                      
            <h3 class="main-title">{{ $collection->name }}</h3>                        
            <div class="row">
                @foreach ($products as $product)                                  
                    <div class="col-xs-6 col-md-3 pull-right">
                        <div class="box-product">
                            ...
                            <a href="/product/{{ $product->id }}" class="btn btn-block"><h3 class="name">{{ $product->name }}</h3></a>
