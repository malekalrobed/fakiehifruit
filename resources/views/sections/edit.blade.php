...
@section('content')
    ...
    <div class="panel-body">          
        <form action="/{{ $pages }}/{{ $section->id }}" method="POST" class="form-horizontal Mycontainer" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Start Name Fild -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" name="old_image" value="{{ $section->image }}">
                </div>
            </div>
            <!-- End image Fild -->
